...
export default function Hero() {
  return (
    <div className="relative z-30 bg-black">
      ...
      <div className="text-center relative bg-black h-128.25" id="hero-div">
        ...
        {/* <div className="absolute inset-0 z-20 pointer-events-none bg-linear-to-b from-black/10 to-black" /> */}
