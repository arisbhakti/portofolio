  ...
  return (
    ...
    >
      ...
      <div className="absolute grid-cols-2 grid-rows-3 bottom-0 z-30  gap-0 hidden md:grid">
        <div className=" size-11.5  bg-primary-400 col-start-1 row-start-1"></div>
        <div className=" size-11.5  bg-primary-400 col-start-2 row-start-2"></div>
        <div className=" size-11.5  bg-primary-400 col-start-1 row-start-3"></div>
      </div>
    </div>
  );
}
