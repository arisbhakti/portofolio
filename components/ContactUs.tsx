...
export default function ContactUs() {
  return (
    <div className="flex flex-col gap-0 w-full md:pb-30! pt-0 md:pt-20! relative md:flex-row md:px-32 md:py-20 md:gap-[122px]">
      {/* 3 boxes */}
      <div className="absolute top-0 left-0 z-30 grid grid-cols-3 grid-rows-2 gap-0 md:hidden">
        <div className="col-start-1 row-start-1 size-8.5 bg-primary-400" />

        <div className="col-start-2 row-start-2 size-8.5 bg-primary-400" />
        <div className="col-start-3 row-start-1 size-8.5 bg-primary-400" />
      </div>
      {/* profile contact us */}
      <div className="w-full relative h-128.5  md:w-[420.89px] md:h-160 ">
        ...
        <div className="pointer-events-none absolute inset-0 z-20 bg-[linear-gradient(to_bottom,rgba(0,0,0,0)_50%,rgba(0,0,0,0.72)_80%,#000000_100%)] md:hidden"></div>
      ...
      <div className="flex flex-col gap-6 px-4 py-10 h-158 realitive md:flex-1 md:gap-12">
        {/* header */}
        ...
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          <div className="absolute bottom-0 right-0 z-0 grid grid-cols-3 grid-rows-2 gap-0 md:hidden">
